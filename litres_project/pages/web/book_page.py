...
class BookPage:
    ...
    def books_must_be_added_to_cart(self, book1, book2):
        ...
        browser.element('div:nth-child(1) > div.Cart-module__bookCard__author_20vL8').should(have.text(book1.author))
        browser.element('div:nth-child(1) > div.Cart-module__bookCard__price_336CO').should(have.text(book1.price))
